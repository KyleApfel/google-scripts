...
def emailTemp(firstname, lastname, title, number, email):
  emailtemplate = """
  <div style="font-size:small">  <font size="4" face="arial, helvetica, sans-serif" color="#000000">    %s %s  </font>   </div>   <div style="font-size:small">  <font face="arial, helvetica, sans-serif" color="#666666">    %s    <br>  </font>  <font face="arial, helvetica, sans-serif" color="#99999">    Office: 405.536.0000 %s    <br>    Email:    <a href="mailto:%s" target="_blank">     %s   </a>       <br><br>   <img src="https://s3.amazonaws.com/Flogistix-Share/signature/logosignature.png" width="96" height="51">   <br><br>   <hr>  </font>   </div>   <font size="1" color="#999999">  This communication along with its attachments may contain confidential information belonging to the sender. This information is intended only for delivery to the individual named above. If you are not the intended recipient, you are hereby notified that any disclosure, copying, distribution, or the taking of any action in reliance on the contents of this transmission is strictly prohibited.   </font>
